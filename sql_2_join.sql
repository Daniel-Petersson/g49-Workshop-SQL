...
SELECT Name AS city_name, Population AS largest_population
FROM city
WHERE Population = (
...
#
select name as city_name, population as smalest_population
from city
...
#
select sum(Population) as total_population_below_1000
from	city
